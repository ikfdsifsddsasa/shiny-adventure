local CONFIG = {
	VALID_KEY = "GAG-PREM-7Kx9",
	TRAP_KEY = "GAG-FREE-0kLm",
...
local ACCENT = Color3.fromRGB(100, 200, 80)
local ACCENT_DARK = Color3.fromRGB(50, 120, 40)
...
local COLORS = {
	...
	stroke = Color3.fromRGB(60, 180, 60),
...
local function buildAuthGui()
	...
	authGui.Name = "GrowAGardenDupAuth"
	...
	subtitle.Text = "Grow a Garden — enter license key"
...
buildMainGui = function()
	...
	mainGui.Name = "GrowAGardenDupDev"
	...
	Sub.Text = "Grow a Garden | RightShift"
	...
	statusLbl.Text = "Ready — Dup Garden placeholder"
	...
	print("[Dup Garden] Menu ready | RightShift = toggle")
end
